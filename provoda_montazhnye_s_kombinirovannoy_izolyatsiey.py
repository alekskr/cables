...
url = 'https://bystrokabel.ru/item/provoda_montazhnye_s_kombinirovannoy_izolyatsiey'
...
# with open('D:\\Python projects\\Beautiful soup\\cables\\provoda_montazhnye_s_kombinirovannoy_izolyatsiey.html', 'w',
...
# with open('D:\Python projects\Beautiful soup\cables\provoda_montazhnye_s_kombinirovannoy_izolyatsiey.html',
...
# for cable_name, cable_link in all_cable_types.items():
    ...
    # src = req.text
    #
    # with open(f'data_provoda_montazhnye_s_kombinirovannoy_izolyatsiey\\{cable_name}.html', 'w', encoding='UTF-8') as f:
    #     f.write(src)
#
#         # count += 1
...
#             with open(f'all_diameters_provoda_montazhnye_s_kombinirovannoy_izolyatsiey\\{file_name[7:]}.html', 'w', encoding='UTF-8') as file:

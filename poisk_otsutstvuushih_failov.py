...
all_files_cable_types = os.listdir('D:\\Python projects\\Beautiful soup\\cables\\all_diameters_provoda_montazhnye_s_kombinirovannoy_izolyatsiey')
...
with open('D:\\Python projects\\Beautiful soup\\cables\\all_diameters_provoda_montazhnye_s_kombinirovannoy_izolyatsiey\\propusk.json', 'w', encoding='UTF-8') as file:
